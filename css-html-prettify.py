...
make_logger("css-html-prettify")  # AutoMagically make a Logger Log
make_root_check_and_encoding_debug()  # AutoMagically Check Encodings/root
set_process_name_and_cpu_priority("css-html-prettify")  # set Name
set_single_instance("css-html-prettify")  # AutoMagically set Single Instance
make_config("css-html-prettify")  # AutoMagically make a JSON-based Config
